            ...
            <tbody>
                @foreach ($data as $d)
                    <tr>
                        ...
                        <td class="text-left py-3 px-4 uppercase font-semibold">{{ $d->user->name }}</td>
                        <td class="text-left py-3 px-4 uppercase font-semibold">{{ $d->judul_pengeluaran }}</td>
                        <td class="text-left py-3 px-4 uppercase font-semibold">{{ $d->deskripsi }}</td>
